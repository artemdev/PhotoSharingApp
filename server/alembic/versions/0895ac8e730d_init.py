...
Revision ID: 0895ac8e730d
Revises: 
Create Date: 2024-05-24 12:17:44.407431
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_pictures_image_url'),
                    'pictures', ['image_url'], unique=True)
